...
class REPLStockCallback implements StockCallback {
    ...
    public void notifyCustomer(int stockID, double newPrice) {
        ...
        // used for judging volume and confirming billing on client side
...
public class REPL {
    private final Set<StockService> svcs;

    REPL(Set<StockService> svcs) {
        this.svcs = svcs;
    }
            ...
            while ((input = br.readLine()) != null) {
                ...
                if ("subscribe".equals(args[0])) {
                    ...
                    for(StockService svc : svcs) {
                        ...
                        t.start(); // new thread per service
                    }
