...
import static main.java.edu.brown.cs32.spring22.Mar01.Utils.timestamp;
...
public class HoursDispatcher {
    ...
    static AtomicInteger studentsHelped = new AtomicInteger(0);
            ...
            if(queue.hasNext()) {
                for(TA ta : this.minutesLeft.keySet()) {
                    if(ta.isFree()) {
                        ...
                        try {
                            // Waiting for this to return! Every time!
                ...
                try {
                    ...
                    System.out.println(timestamp()+" Dispatcher ("+studentsHelped+"): Nobody waiting in queue, will check again in three seconds.");
                    Thread.sleep(3000);
